...
pub trait State {
    fn update(&mut self, ctx: &crate::context::Context);
    fn draw(&self, gfx: &mut crate::graphics::Graphics);
    ...
    fn handle_mouse_move(&mut self, position: winit::dpi::PhysicalPosition<i32>) -> bool { false }
